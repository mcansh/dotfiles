...
function tryDir(dirname, helper) {
    var taglibPath = nodePath.join(dirname, 'marko.json');
...
function tryNodeModules(parent, helper) {
    ...
    if ((nodeModulesDir = realpathCached(nodeModulesDir))) {
        ...
        var handlePackageDir = function(packageName) {
            ...
            var taglibPath = nodePath.join(moduleDir, 'marko.json');
...
<<<<<<< HEAD:compiler/taglib-finder/index.js
}
...
>>>>>>> 74fe4d91bcbd529d148e9b037ce8dae8b49d1e76:compiler/taglibs/taglib-finder.js
